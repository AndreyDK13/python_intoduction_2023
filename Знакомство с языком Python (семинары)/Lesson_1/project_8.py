# # 5. Вагоны в электричке 
# пронумерованы натуральными числами, 
# начиная с 1 
...
i = int (input ("Введите номер вагона от головы поезда i >>"))
j = int (input ("Введите номер вагона от головы поезда j >>"))

q = i + j - 1

print (f'Всего вагонов - {q}')